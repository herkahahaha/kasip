...
function Order(props)
{
    ...
    const order = useSelector(({vesselApp}) => vesselApp.order);
                    ...
                    <div className="flex flex-1 w-full items-center justify-between">
                        ...
                        <div className="flex flex-1 flex-col items-center sm:items-start">
                            ...
                            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/vessel/orders" color="inherit">
...
export default withReducer('vesselApp', reducer)(Order);
